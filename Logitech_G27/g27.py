...
class Controller:
    ...
    def __init__(self, id, dead_zone=0.1):
        """
        ...
        self._steer_idx     = int(self._parser.get('G27 Racing Wheel', 'steering_wheel'))
        self._clutch_idx  = int(self._parser.get('G27 Racing Wheel', 'gear'))
        self._throttle_idx = int(self._parser.get('G27 Racing Wheel', 'throttle'))
        ...
        self._handbrake_idx = int(self._parser.get('G27 Racing Wheel', 'handbrake'))
